<template>
    <div>
        ...
        <div class="data-history-container">
            ...
            <router-link
                v-if="traineeData.totalData != 0"
                :to="{ name: 'dataHistoryDetails', params: { traineeId: router.currentRoute.value.params.traineeId, dataId: data.id } }"
                class="data-row"
...
import { getTTraineeData } from "@/services/traineeServices/traineeServices.js"
