...
const isDisable = computed(() => {
    console.log("isDisable",normalData.value)
    return !(normalData.value.gender != null && normalData.value.height != null && normalData.value.weight != null && normalData.value.bodyCircumferences != null &&
