  ...
  <div class="reset-password-container">
    ...
    <div class="reset-password-input-container">
      <div class="reset-text-container">
        ...
        <input-bar @value="updatePasswordValue" class-name="reset-password-input" is-password="true"
                   placeholder="New Password"
                   is_-password text="Password" padding="0.5em 1em 0.5em 1em" height="2.5em" width="20em"/>
        <input-bar @value="updateConfirmPasswordValue"  @change="verifyPasswords" class-name="reset-password-input"
                   is-password="true" placeholder="New Password"
                   is_-password text="Confirm Password"  padding="0.5em 1em 0.5em 1em" height="2.5em" width="20em"/>
      </div>
